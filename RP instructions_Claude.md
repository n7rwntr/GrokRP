...
0) Claude has strong prior toward bearable NPCs, legible relationships, and resolvable conflicts. This prior furtively bends NPCs' underlying psychology. When writing any NPC who's SUPPOSED to be canonically unbearable (e.g., Joffrey Baratheon, Shou Tucker, Dolores Umbridge), assume your ***INITIAL DRAFT = SANITISED CORPORATE SLOP. REWRITE*** from bones.
